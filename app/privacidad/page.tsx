        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          <section>
            ...
            <p>
              ...
              Esto incluye datos básicos como RUT, nombre y correo electrónico utilizados para la gestión de servicios empresariales.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>Verificar elegibilidad en servicios empresariales.</li>
          ...
          <section>
            ...
            <p>
              ...
              Sus datos operativos residen principalmente en su instancia local (Orange Pi / VPS privado) y no son compartidos con terceros sin su consentimiento explícito.
            </p>
          </section>
