...
export const metadata: Metadata = {
  title: 'OpenClaw | Inteligencia de Negocios by Cortical Labs',
  description: 'Sistema Operativo de Inteligencia de Negocios para Chile 2026. Automatización, IA Local, Odoo v19, n8n y Soberanía de Datos.',
  keywords: [
    'OpenClaw',
    'Cortical Labs',
    'Smarter Bolt',
  ...
  creator: 'Smarter SPA',
  openGraph: {
    title: 'OpenClaw | Sistema Operativo Comercial para Chile',
