...
const products = [
  {
    id: "jetson-agro",
    tier: "AgroBusiness · Inversión",
    badge: "🟢 NVIDIA Jetson Agro",
    badgeBg: "bg-emerald-500/10 text-emerald-600 border-emerald-500/20",
    name: "Jetson Orin Nano",
    tagline: "IA en el Campo",
    specs: "66 TOPS AI",
    specBg: "bg-emerald-100 text-emerald-800",
    description:
      "Automatización para Agrobusiness. Monitoreo de cultivos, riego inteligente y análisis de suelo en tiempo real con IA local. Inversión inteligente en soberanía alimentaria.",
    image: "/Users/mac/.gemini/antigravity/brain/c1fe47ba-8b59-466e-94dc-2a9a2e92701a/nvidia_jetson_agro_future_1773603148480.png",
    iconColor: "text-emerald-600",
    features: [
      "Visión computacional para cultivos",
      "Control de riego autónomo",
      "Procesamiento 100% off-grid",
      "NVIDIA Jetson Orin Nano Industrial",
    ],
    highlight: true,
    price: "$1.299.000",
  ...
  {
    id: "orangepi5",
    tier: "Comercio · Startup",
    badge: "🟡 Orange Pi 5 Plus",
    ...
    description:
      "Ideal para estudios contables, startups y comercios en crecimiento. Odoo v19 + agente CLAW + Bolt Studio corriendo 24/7 en tu oficina con eficiencia energética total.",
    image: "/Users/mac/.gemini/antigravity/brain/c1fe47ba-8b59-466e-94dc-2a9a2e92701a/media__1773603076449.jpg",
  ...
  {
    id: "orangepi6",
    tier: "Enterprise · Universidad",
    badge: "🔵 Orange Pi 6",
    badgeBg: "bg-indigo-500/10 text-indigo-600 border-indigo-500/20",
    name: "Orange Pi 6 Plus",
    tagline: "Servidor enterprise",
    specs: "64 GB RAM",
    specBg: "bg-indigo-100 text-indigo-800",
    description:
      "Servidor de alta disponibilidad multi-tenant. La propuesta de inversión definitiva para grandes infraestructuras. Múltiples agentes y bases de datos por cliente.",
    image: "/Users/mac/.gemini/antigravity/brain/c1fe47ba-8b59-466e-94dc-2a9a2e92701a/media__1773595606095.jpg",
    iconColor: "text-indigo-500",
    features: [
      "Multi-tenant aislado",
      "Alta disponibilidad 99.9%",
      "Propuesta Cortical Labs Cloud",
